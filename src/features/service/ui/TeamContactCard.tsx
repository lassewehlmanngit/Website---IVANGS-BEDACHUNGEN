  ...
  return (
    <div className="bg-white p-6 rounded-sm shadow-sm border border-slate-100 hover:border-primary/50 transition-colors">
      ...
      <div className="flex gap-3">
        <button 
          className="p-2.5 bg-white border border-primary text-primary rounded-full hover:bg-primary hover:text-white transition-colors" 
          title="Anrufen" 
          aria-label={`Anrufen bei ${member.name}`}
        >
          <Phone size={16}/>
        </button>
        <button 
