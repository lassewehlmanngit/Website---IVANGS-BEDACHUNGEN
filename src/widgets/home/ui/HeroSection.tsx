      ...
      <div className="relative z-20 container mx-auto px-4 py-20 lg:py-32 xl:py-40 grid lg:grid-cols-2 gap-16 items-center flex-grow">
        ...
        <div className="text-white mt-8 md:mt-0">
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-4 animate-slide-up flex-wrap">
            <SmartLink link={heroData?.buttons?.primaryLink || `/contact`} className="w-full sm:w-auto">
              <Button size="lg" className="w-full shadow-lg shadow-primary/30" data-tina-field={homeData?.hero?.buttons && tinaField(homeData.hero.buttons, 'primaryText')}>
            ...
            <SmartLink link={heroData?.buttons?.secondaryLink || `/career`} className="w-full sm:w-auto">
              <Button variant="outline" size="lg" className="w-full bg-white/10 text-white border-white/20 hover:bg-white/20" data-tina-field={homeData?.hero?.buttons && tinaField(homeData.hero.buttons, 'secondaryText')}>
        ...
        {showQuickForm && (
          <div className="hidden md:block">
            <div className="bg-slate-800/90 supports-[backdrop-filter]:bg-white/10 backdrop-blur-xl border border-white/20 p-8 rounded-sm shadow-lg max-w-md ml-auto relative overflow-hidden animate-fade-in">
              {/* Decorative Blur */}
